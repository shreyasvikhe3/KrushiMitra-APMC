...
const Home = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(34,197,94,0.22),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(251,191,36,0.16),_transparent_30%),linear-gradient(180deg,_#f6fff3_0%,_#eef8f1_48%,_#f8fafc_100%)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.18),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(245,158,11,0.12),_transparent_24%),linear-gradient(180deg,_#020617_0%,_#0f172a_48%,_#111827_100%)]">
      ...
      <div className="absolute left-1/2 top-20 h-56 w-56 -translate-x-1/2 rounded-full bg-emerald-200/30 blur-3xl dark:bg-emerald-500/10" />
      ...
      <div className="container relative mx-auto px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
        <section className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/login"
                className="inline-flex items-center justify-center rounded-2xl bg-emerald-700 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-700/20 transition hover:-translate-y-0.5 hover:bg-emerald-800"
              >
                {t('home.loginCta')}
              </Link>
              <Link
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="rounded-3xl border border-white/70 bg-white/75 p-5 shadow-[0_18px_45px_rgba(15,23,42,0.08)] backdrop-blur dark:border-slate-800/80 dark:bg-slate-900/70 dark:shadow-[0_20px_55px_rgba(2,6,23,0.4)]">
          ...
          <div className="relative">
            <div className="absolute -left-8 top-8 hidden h-24 w-24 rounded-full bg-amber-300/40 blur-2xl lg:block" />
            <div className="absolute -right-6 bottom-10 hidden h-32 w-32 rounded-full bg-emerald-300/40 blur-2xl lg:block" />

            <div className="relative overflow-hidden rounded-[32px] border border-white/60 bg-slate-900 px-6 py-6 text-white shadow-[0_30px_80px_rgba(15,23,42,0.22)] sm:px-8 sm:py-8 dark:border-slate-700/60 dark:bg-slate-950 dark:shadow-[0_32px_90px_rgba(2,6,23,0.55)]">
        ...
        <section className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="group rounded-[28px] border border-emerald-100 bg-white/80 p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)] backdrop-blur transition hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(15,23,42,0.1)] dark:border-slate-800/70 dark:bg-slate-900/70 dark:shadow-[0_22px_55px_rgba(2,6,23,0.35)]">
          ...
          <div className="group rounded-[28px] border border-amber-100 bg-white/80 p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)] backdrop-blur transition hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(15,23,42,0.1)] dark:border-slate-800/70 dark:bg-slate-900/70 dark:shadow-[0_22px_55px_rgba(2,6,23,0.35)]">
          ...
          <div className="group rounded-[28px] border border-sky-100 bg-white/80 p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)] backdrop-blur transition hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(15,23,42,0.1)] dark:border-slate-800/70 dark:bg-slate-900/70 dark:shadow-[0_22px_55px_rgba(2,6,23,0.35)]">
